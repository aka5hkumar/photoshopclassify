...
class RedditGetImages:
    ...
    def getPosts(self, search_filter, limit): # Get post IDs and respective images, returns one list
        resp_post = requests.get('{}/{}.json?t=all&limit={}'.format(self.url,search_filter,limit)) 
        posts_list=[]
    ...
    def main(self,limit,search_filter):
        post_list = self.getPosts(search_filter,limit)
